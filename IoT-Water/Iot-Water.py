...
class expert_system:
    ...
    def __init__(self):
        self.cod_valid = pd.read_csv('IoT-Water/COD_valid.csv', index_col=False)
...
class Async_getData:
    ...
    def get_data_thread(*args):
        cod_valid = pd.read_csv('IoT-Water/COD_valid.csv', index_col=False)['fit']
        with app.app_context():
